...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.VideosApi(api_client)
    video_properties = openapi_client.VideoProperties() # VideoProperties | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.VideosApi(api_client)
    video_id = '{{videoId}}' # str | Id of the video
    video_multipart_upload_finalize = openapi_client.VideoMultipartUploadFinalize() # VideoMultipartUploadFinalize |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.VideosApi(api_client)
    video_id = '{{videoId}}' # str | Id of the video
    video_multipart_upload_init = openapi_client.VideoMultipartUploadInit() # VideoMultipartUploadInit |  (optional)
